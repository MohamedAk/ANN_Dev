...
namespace Anzu.AnnPortal.Data.EntityManager
{
    public class BaseRepository : IRepository
    {
        ...
        {
            string query = (isDesc == true) ? query = "DESC" : query = "ASC";

            IQueryable<T> results = context.Set<T>().OrderBy("Id " + query).Take(noOfItem);
            return results;
        }
        ...
        /// <returns></returns>
        public List<ServiceDTO> GetServicesFromStagingByEMRId(string emrId)
        {
            try
            {
                var data = context.Database.SqlQuery<ServiceDTO>("EXEC [dbo].[GetServicesFromStaging] @emrId = " + emrId).ToList();
                return data;
            }
            catch (Exception)
            {
        ...
        /// <summary>
        /// Gets the status of the SQL jobs
        /// </summary>
        /// <returns></returns>
        public List<SqlJobDTO> GetSqlJobStatus()
        {
            try
            {
                var data = context.Database.SqlQuery<SqlJobDTO>("EXEC [dbo].[GetJobStatus] @jobName = 'ANN ETL Process'").ToList();
                // EXEC msdb.dbo.sp_help_job @job_name = N'ANN ETL Process', @job_aspect = N'ALL'
                return data;
            }
            catch (Exception)
            {
        ...
        public List<string> ValidateEmrStatus(string emrId)
        {

            try
            {
                var data = context.Database.SqlQuery<string>("EXEC [dbo].[ValidateEmrStatus] @emrId = " + emrId).ToList();
                return data;
            }
            catch (Exception)
            {
        ...
        public List<JobStatusDTO> GetJobRunningStatus()
        {
            try
            {
                var data = context.Database.SqlQuery<JobStatusDTO>("EXEC [dbo].[GetJobQueueStatus]").ToList();
                return data;
            }
            catch (Exception)
            {
        ...
        public List<string> GetServiceEmailList()
        {
            try
            {
                var data = context.Database.SqlQuery<string>("EXEC [dbo].[GetServiceEmailList]").ToList();
                return data;
            }
            catch (Exception)
            {
        ...
        public int PracticeReActivatedCheck(string emrId)
        {
            try
            {
                var data = context.Database.SqlQuery<int>("EXEC [dbo].[SP_ISPractice_Activated_Recently] @emrId = " + emrId).FirstOrDefault();
                return data;
            }
            catch (Exception)
            {
        ...
        public int CheckPracticeData(string emrId)
        {
            try
            {
                var data = context.Database.SqlQuery<int>("EXEC [dbo].[SP_IsDataDeleted] @emrId = " + emrId).FirstOrDefault();
                return data;
            }
            catch (Exception)
            {
